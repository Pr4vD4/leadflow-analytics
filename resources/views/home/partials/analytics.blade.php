...
<section id="analytics" class="py-24 bg-white dark:bg-secondary-900">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-2 bg-secondary-50 dark:bg-secondary-800 rounded-xl overflow-hidden shadow-lg" data-aos="zoom-in">
                <img class="w-full" src="https://via.placeholder.com/800x400?text=Analytics+Dashboard" alt="Дашборд аналитики">
            </div>
